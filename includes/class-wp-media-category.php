...
if ( ! class_exists( 'Wp_Media_Category' ) ) :
    ...
    class Wp_Media_Category {
        ...
        private function load_dependencies() {
            // Use constants for file paths to ensure consistency
            if ( ! defined( 'WPMC_PLUGIN_PATH' ) ) {
                wp_die( 'Plugin path not defined.' );
            }
             ...
             * core plugin.
             */
            require_once WPMC_PLUGIN_PATH . 'includes/class-wp-media-category-loader.php';

            /**
             * The class responsible for defining internationalization functionality
             * of the plugin.
             */
            require_once WPMC_PLUGIN_PATH . 'includes/class-wp-media-category-i18n.php';

            /**
             * The class responsible for defining all actions that occur in the admin area.
             */
            require_once WPMC_PLUGIN_PATH . 'admin/class-wp-media-category-admin.php';

            /**
             * The class responsible for displaying review notices.
             */
            require_once WPMC_PLUGIN_PATH . 'admin/class-admin-review.php';

            /**
             * The class responsible for defining all actions that occur in the public-facing
             * side of the site.
             */
            require_once WPMC_PLUGIN_PATH . 'public/class-wp-media-category-public.php';
        ...
        private function define_admin_hooks() {
            ...
            $this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'wpmc_enqueue_scripts' );
            ...
            // Bulk actions
            $this->loader->add_filter( 'bulk_actions-upload', $plugin_admin, 'wpmc_add_media_category_bulk_action' );
        ...
        private function define_public_hooks() {
            ...
            // Public assets - only load when needed
